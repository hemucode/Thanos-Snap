...
function linkButton() {
  document.querySelector('.teaser').href = `https://www.needevery.in/2022/08/prank-your-friends-for-this-extension.html`;
  ...
  document.querySelector('.website').href = `https://www.needevery.in/`;
}
...
function headericons(){
    window.open("https://www.needevery.in/2022/08/prank-your-friends-for-this-extension.html#CSS2",'_blank');
}
